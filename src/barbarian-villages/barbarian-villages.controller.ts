...
export class BarbarianVillagesController {
  ...
  //   example: 1
  // })
  // async findAttackable(@Param('serverId', ParseIntPipe) serverId: number) {
  //   return await this.barbarianVillagesService.findAttackableVillages(serverId);
  // }
  ...
  // @Post(':serverId/execute-mini-attacks')
  // @ApiOperation({
  ...
  //   const result = await this.barbarianVillagesService.executeMiniAttacks(serverId);
  //   return {
